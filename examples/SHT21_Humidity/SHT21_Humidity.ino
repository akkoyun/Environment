...
void loop() {
	...
	// Measure
	Environment.SHT21_H(Sensor_Read_Count, Sensor_Average_Type, _Measurement, _Deviation);
	...
	// Serial Print Data
	Serial.print("Function Version        : "); Serial.println(Environment.SHT21_H_Version);
